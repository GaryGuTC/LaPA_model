...
class MTDataModule(LightningDataModule):
    def __init__(self, _config, dist=False): 
        datamodule_keys = _config["datasets"] # ["medicat", "roco"]
        ...
        self.batch_size = self.dms[0].batch_size # 8
        self.vocab_size = self.dms[0].vocab_size # 50265
        self.num_workers = self.dms[0].num_workers # 8
